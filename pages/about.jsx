  ...
  return (
    <>
      <main className={styles.about__main}>
        ...
        {frontCom && <Skill data={FRONT} closeMethod={setFrontCom} />}
        {backCom && <Skill data={BACK} closeMethod={setBackCom} />}
        {cicdCom && <Skill data={CICD} closeMethod={setCicdCom} />}
        ...
        <ul className={`${styles.list} ${styles.goal__text}`}>
          ...
          <li className={styles.award}>21.06 정보처리기사 자격증</li>
        </ul>
      </main>
    </>
  );
